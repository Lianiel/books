...
export const BOOK_CHAPTERS: Record<string, ChapterInfo[]> = {
  ...
  book33: [
    ...
    { id: 'chapter4', title: '第4章 其他與罪有關的言說', path: '/book33/chapter4' },
    { id: 'chapter5', title: '第5章 現代華人與「罪」的關係', path: '/book33/chapter5' },
    { id: 'chapter6', title: '第6章 從罪得釋放──華人文化更新之路', path: '/book33/chapter6' },
    { id: 'conclusion', title: '結論', path: '/book33/conclusion' },
    { id: 'bibliography', title: '參考書目', path: '/book33/bibliography' },
  ],
  book34: [
    ...
    { id: 'chapter2', title: '第2章 時間', path: '/book34/chapter2' },
    { id: 'chapter3', title: '第3章 什麼是相連？', path: '/book34/chapter3' },
    { id: 'chapter4', title: '第4章 當我們不能與人相連時', path: '/book34/chapter4' },
    { id: 'chapter5', title: '第5章 學習相連', path: '/book34/chapter5' },
    { id: 'chapter6', title: '第6章 何為界限', path: '/book34/chapter6' },
    { id: 'chapter7', title: '第7章 我們如何發展界限', path: '/book34/chapter7' },
    { id: 'chapter8', title: '第8章 越界', path: '/book34/chapter8' },
    { id: 'chapter9', title: '第9章 當我們沒有界限', path: '/book34/chapter9' },
    { id: 'chapter10', title: '第10章 學習設限', path: '/book34/chapter10' },
    { id: 'chapter11', title: '第11章 問題在哪裡？', path: '/book34/chapter11' },
    { id: 'chapter12', title: '第12章 當我們不接納善與惡', path: '/book34/chapter12' },
    { id: 'chapter13', title: '第13章 學習同時接受善與惡', path: '/book34/chapter13' },
    { id: 'chapter14', title: '第14章 什麼是成人？', path: '/book34/chapter14' },
    { id: 'chapter15', title: '第15章 當我們沒有長大', path: '/book34/chapter15' },
    { id: 'chapter16', title: '第16章 學習長大成熟', path: '/book34/chapter16' },
  ...
  book37: [
    { id: 'home', title: '書本簡介', path: '/book37/home' },
    { id: 'preface', title: '序言：看見了就是你的', path: '/book37/preface' },
    { id: 'chapter1', title: '第一講 神賜下復興的目的', path: '/book37/chapter1' },
    { id: 'chapter2', title: '第二講 單單愛主你的神', path: '/book37/chapter2' },
    { id: 'chapter3', title: '第三講 在愛中行事的信心', path: '/book37/chapter3' },
    { id: 'chapter4', title: '第四講 存謙卑的心與神同行', path: '/book37/chapter4' },
    { id: 'chapter5', title: '第五講 讓耶穌透過你活出來', path: '/book37/chapter5' },
  ],
  book38: [
    { id: 'home', title: '書本簡介', path: '/book38/home' },
    { id: 'preface', title: '序', path: '/book38/preface' },
    { id: 'chapter1', title: '第一章 誰是聖靈？', path: '/book38/chapter1' },
    { id: 'chapter2', title: '第二章 與我同行', path: '/book38/chapter2' },
    { id: 'chapter3', title: '第三章 揚起船帆', path: '/book38/chapter3' },
    { id: 'chapter4', title: '第四章 心中的哀嘆', path: '/book38/chapter4' },
    { id: 'chapter5', title: '第五章 救恩的確據', path: '/book38/chapter5' },
    { id: 'chapter6', title: '第六章 平息一切混亂', path: '/book38/chapter6' },
    { id: 'chapter7', title: '第七章 如何聆聽神的聲音', path: '/book38/chapter7' },
    { id: 'chapter8', title: '第八章 點燃靈魂', path: '/book38/chapter8' },
    { id: 'chapter9', title: '第九章 滴滿脂油的路徑', path: '/book38/chapter9' },
    { id: 'chapter10', title: '第十章 活水湧流', path: '/book38/chapter10' },
    { id: 'chapter11', title: '第十一章 放膽講論神的道', path: '/book38/chapter11' },
    { id: 'chapter12', title: '第十二章 釋放你的潛力', path: '/book38/chapter12' },
    { id: 'chapter13', title: '第十三章 讓枯骨得著氣息', path: '/book38/chapter13' },
  ],
  book39: [
    { id: 'home', title: '書本簡介', path: '/book39/home' },
    ...
    { id: 'chapter5', title: '第五章 從心出發——奧古斯丁倫理學', path: '/book39/chapter5' },
    { id: 'chapter6', title: '第六章 活出自由——路德倫理學', path: '/book39/chapter6' },
    { id: 'chapter7', title: '第七章 與基督連結——加爾文倫理學', path: '/book39/chapter7' },
    { id: 'chapter8', title: '第八章 跟隨基督的關鍵少數——重洗派倫理學', path: '/book39/chapter8' },
    { id: 'chapter9', title: '第九章 追求成聖——衛斯理倫理學', path: '/book39/chapter9' },
    { id: 'chapter10', title: '第十章 聖言與聖傳——天主教倫理學', path: '/book39/chapter10' },
    { id: 'chapter11', title: '第十一章 培養倫理道德習慣——德行倫理學', path: '/book39/chapter11' },
    { id: 'chapter12', title: '第十二章 尼布爾式理想主義——務實倫理學', path: '/book39/chapter12' },
    { id: 'chapter13', title: '第十三章 自發性回應責任——責任倫理學', path: '/book39/chapter13' },
    { id: 'chapter14', title: '第十四章 為主抉擇——潘霍華倫理學', path: '/book39/chapter14' },
  ...
  book40: [
    ...
    { id: 'chapter3', title: '第三章 從十誡看倫理（一）——十誡緒論', path: '/book40/chapter3' },
    { id: 'chapter4', title: '第四章 第一誡：除了耶和華以外，你不可有別的神', path: '/book40/chapter4' },
    { id: 'chapter5', title: '第五章 第二誡：不可跪拜偶像', path: '/book40/chapter5' },
    { id: 'chapter6', title: '第六章 第三誡：不可妄稱耶和華的名', path: '/book40/chapter6' },
    { id: 'chapter7', title: '第七章 第四誡：當守安息日', path: '/book40/chapter7' },
    { id: 'chapter8', title: '第八章 第五誡：尊重權柄——順服神在地上的代表', path: '/book40/chapter8' },
    { id: 'chapter9', title: '第九章 第六誡（上）：不可殺人——戰爭與死刑', path: '/book40/chapter9' },
    { id: 'chapter10', title: '第十章 第六誡（下）：不可殺人——安樂死、墮胎與迦南人', path: '/book40/chapter10' },
    { id: 'chapter11', title: '第十一章 第七誡（一）：不可姦淫——婚前性行為', path: '/book40/chapter11' },
    { id: 'chapter12', title: '第十二章 第七誡（二）：不可姦淫——婚外情', path: '/book40/chapter12' },
    { id: 'chapter13', title: '第十三章 第七誡（三）：不可姦淫——通姦除罪問題', path: '/book40/chapter13' },
    { id: 'chapter14', title: '第十四章 第七誡（四）：不可姦淫——離婚', path: '/book40/chapter14' },
    { id: 'chapter15', title: '第十五章 第七誡（五）：不可姦淫——再婚與跨信仰婚姻', path: '/book40/chapter15' },
    { id: 'chapter16', title: '第十六章 第七誡（六）：不可姦淫——同性戀', path: '/book40/chapter16' },
    { id: 'chapter17', title: '第十七章 第八誡：不可偷盜——基督徒的錢財觀', path: '/book40/chapter17' },
  ...
  book41: [
    ...
    { id: 'chapter7', title: '第二部 2-1　榮辱感第一項：榮耀之愛', path: '/book41/chapter7' },
    { id: 'chapter8', title: '第二部 2-2　榮辱感第二項：兩種榮耀來源', path: '/book41/chapter8' },
    { id: 'chapter9', title: '第二部 2-3　榮辱感第三項：資源有限的概念', path: '/book41/chapter9' },
    { id: 'chapter10', title: '第二部 2-4　榮辱感第四項：挑戰和反擊', path: '/book41/chapter10' },
    { id: 'chapter11', title: '第二部 2-5　榮辱感第五項：情面概念', path: '/book41/chapter11' },
    { id: 'chapter12', title: '第二部 2-6　榮辱感第六項：身體語言', path: '/book41/chapter12' },
    { id: 'chapter13', title: '第二部 2-7　榮辱感第七項：守護關係', path: '/book41/chapter13' },
    { id: 'chapter14', title: '第二部 2-8　榮辱感第八項：名字／親屬關係／血統', path: '/book41/chapter14' },
    { id: 'chapter15', title: '第二部 2-9　榮辱感第九項：潔淨', path: '/book41/chapter15' },
    { id: 'chapter16', title: '第二部 2-10　榮耀地位的逆轉是聖經的主題', path: '/book41/chapter16' },
    { id: 'chapter17', title: '第三部 3-1　福音為「榮耀之愛」所形塑？', path: '/book41/chapter17' },
    { id: 'chapter18', title: '第三部 3-2　福音為「兩種榮耀來源」所形塑？', path: '/book41/chapter18' },
    { id: 'chapter19', title: '第三部 3-3　福音為「資源有限的概念」所形塑？', path: '/book41/chapter19' },
    { id: 'chapter20', title: '第三部 3-4　福音為「挑戰與反擊」所形塑？', path: '/book41/chapter20' },
    { id: 'chapter21', title: '第三部 3-5　福音為「情面概念」所形塑？', path: '/book41/chapter21' },
    { id: 'chapter22', title: '第三部 3-6　福音為「身體語言」的動力所形塑？', path: '/book41/chapter22' },
    { id: 'chapter23', title: '第三部 3-7　福音為「守護關係」的動力所形塑？', path: '/book41/chapter23' },
    { id: 'chapter24', title: '第三部 3-8　福音為「名字／親屬關係／血統」的動力所形塑？', path: '/book41/chapter24' },
    { id: 'chapter25', title: '第三部 3-9　福音為「潔淨」的動力所形塑？', path: '/book41/chapter25' },
    { id: 'chapter26', title: '第三部 3-10　福音為「榮耀地位的逆轉」所形塑？', path: '/book41/chapter26' },
  ],
};
...
const STATIC_BOOKS = [
  ...
  { book_id: 'book41', title: '世界等待的福音', author: '沃爾納．米胥克（Werner Mischke）　著', description: '探討聖經中榮耀與羞辱的核心文化價值，指出西方以「罪疚/清白」為主的福音框架，如何忽略了更貼近多數世界（亞、非、拉丁美洲及中東）文化處境的「榮辱」動力。全書分四部（洞悉、隱視、形塑、遍傳）剖析榮辱感如何形塑聖經敘事與普世宣教策略，結合大量跨文化實例與學術研究，是跨文化宣教與處境化神學的重要著作。目前已完成前言、第一部「洞悉」（6節）、第二部「隱視」（全10節）與第三部「形塑」（全10節，逐一探討十種榮辱動力如何形塑全球福音的呈現方式），連載中。', chapters_count: 27 },
];
...
const BOOK_CATEGORIES: BookCategory[] = [
  { name: '禱告靈修', icon: '🙏', color: '#7c3aed', bg: '#f5f3ff', bookNumbers: [9, 10, 14, 16, 35, 36, 37, 38] },
  { name: '聖經研讀', icon: '📖', color: '#b45309', bg: '#fffbeb', bookNumbers: [6, 12, 23, 29, 30, 31, 32, 40] },
...
const Book33Ch5 = lazyWithRetry(() => import('./components/book33/Book33Ch5'));
const Book33Ch6 = lazyWithRetry(() => import('./components/book33/Book33Ch6'));
const Book33Conclusion = lazyWithRetry(() => import('./components/book33/Book33Conclusion'));
const Book33Bibliography = lazyWithRetry(() => import('./components/book33/Book33Bibliography'));
...
const Book34Ch2 = lazyWithRetry(() => import('./components/book34/Book34Ch2'));
const Book34Ch3 = lazyWithRetry(() => import('./components/book34/Book34Ch3'));
const Book34Ch4 = lazyWithRetry(() => import('./components/book34/Book34Ch4'));
const Book34Ch5 = lazyWithRetry(() => import('./components/book34/Book34Ch5'));
const Book34Ch6 = lazyWithRetry(() => import('./components/book34/Book34Ch6'));
const Book34Ch7 = lazyWithRetry(() => import('./components/book34/Book34Ch7'));
const Book34Ch8 = lazyWithRetry(() => import('./components/book34/Book34Ch8'));
const Book34Ch9 = lazyWithRetry(() => import('./components/book34/Book34Ch9'));
const Book34Ch10 = lazyWithRetry(() => import('./components/book34/Book34Ch10'));
const Book34Ch11 = lazyWithRetry(() => import('./components/book34/Book34Ch11'));
const Book34Ch12 = lazyWithRetry(() => import('./components/book34/Book34Ch12'));
const Book34Ch13 = lazyWithRetry(() => import('./components/book34/Book34Ch13'));
const Book34Ch14 = lazyWithRetry(() => import('./components/book34/Book34Ch14'));
const Book34Ch15 = lazyWithRetry(() => import('./components/book34/Book34Ch15'));
...
const Book37Home = lazyWithRetry(() => import('./components/book37/Book37Home'));
const Book37Preface = lazyWithRetry(() => import('./components/book37/Book37Preface'));
const Book37Ch1 = lazyWithRetry(() => import('./components/book37/Book37Ch1'));
const Book37Ch2 = lazyWithRetry(() => import('./components/book37/Book37Ch2'));
const Book37Ch3 = lazyWithRetry(() => import('./components/book37/Book37Ch3'));
const Book37Ch4 = lazyWithRetry(() => import('./components/book37/Book37Ch4'));
const Book37Ch5 = lazyWithRetry(() => import('./components/book37/Book37Ch5'));
const Book38Home = lazyWithRetry(() => import('./components/book38/Book38Home'));
const Book38Preface = lazyWithRetry(() => import('./components/book38/Book38Preface'));
const Book38Ch1 = lazyWithRetry(() => import('./components/book38/Book38Ch1'));
const Book38Ch2 = lazyWithRetry(() => import('./components/book38/Book38Ch2'));
const Book38Ch3 = lazyWithRetry(() => import('./components/book38/Book38Ch3'));
const Book38Ch4 = lazyWithRetry(() => import('./components/book38/Book38Ch4'));
const Book38Ch5 = lazyWithRetry(() => import('./components/book38/Book38Ch5'));
const Book38Ch6 = lazyWithRetry(() => import('./components/book38/Book38Ch6'));
const Book38Ch7 = lazyWithRetry(() => import('./components/book38/Book38Ch7'));
const Book38Ch8 = lazyWithRetry(() => import('./components/book38/Book38Ch8'));
const Book38Ch9 = lazyWithRetry(() => import('./components/book38/Book38Ch9'));
const Book38Ch10 = lazyWithRetry(() => import('./components/book38/Book38Ch10'));
const Book38Ch11 = lazyWithRetry(() => import('./components/book38/Book38Ch11'));
const Book38Ch12 = lazyWithRetry(() => import('./components/book38/Book38Ch12'));
const Book38Ch13 = lazyWithRetry(() => import('./components/book38/Book38Ch13'));

// ========== Book 39 章節（懶加載） ==========
const Book39Home = lazyWithRetry(() => import('./components/book39/Book39Home'));
...
const Book39Ch5 = lazyWithRetry(() => import('./components/book39/Book39Ch5'));
const Book39Ch6 = lazyWithRetry(() => import('./components/book39/Book39Ch6'));
const Book39Ch7 = lazyWithRetry(() => import('./components/book39/Book39Ch7'));
const Book39Ch8 = lazyWithRetry(() => import('./components/book39/Book39Ch8'));
const Book39Ch9 = lazyWithRetry(() => import('./components/book39/Book39Ch9'));
const Book39Ch10 = lazyWithRetry(() => import('./components/book39/Book39Ch10'));
const Book39Ch11 = lazyWithRetry(() => import('./components/book39/Book39Ch11'));
const Book39Ch12 = lazyWithRetry(() => import('./components/book39/Book39Ch12'));
const Book39Ch13 = lazyWithRetry(() => import('./components/book39/Book39Ch13'));
const Book39Ch14 = lazyWithRetry(() => import('./components/book39/Book39Ch14'));
...
const Book40Ch3 = lazyWithRetry(() => import('./components/book40/Book40Ch3'));
const Book40Ch4 = lazyWithRetry(() => import('./components/book40/Book40Ch4'));
const Book40Ch5 = lazyWithRetry(() => import('./components/book40/Book40Ch5'));
const Book40Ch6 = lazyWithRetry(() => import('./components/book40/Book40Ch6'));
const Book40Ch7 = lazyWithRetry(() => import('./components/book40/Book40Ch7'));
const Book40Ch8 = lazyWithRetry(() => import('./components/book40/Book40Ch8'));
const Book40Ch9 = lazyWithRetry(() => import('./components/book40/Book40Ch9'));
const Book40Ch10 = lazyWithRetry(() => import('./components/book40/Book40Ch10'));
const Book40Ch11 = lazyWithRetry(() => import('./components/book40/Book40Ch11'));
const Book40Ch12 = lazyWithRetry(() => import('./components/book40/Book40Ch12'));
const Book40Ch13 = lazyWithRetry(() => import('./components/book40/Book40Ch13'));
const Book40Ch14 = lazyWithRetry(() => import('./components/book40/Book40Ch14'));
const Book40Ch15 = lazyWithRetry(() => import('./components/book40/Book40Ch15'));
const Book40Ch16 = lazyWithRetry(() => import('./components/book40/Book40Ch16'));
...
const Book41Ch7 = lazyWithRetry(() => import('./components/book41/Book41Ch7'));
const Book41Ch8 = lazyWithRetry(() => import('./components/book41/Book41Ch8'));
const Book41Ch9 = lazyWithRetry(() => import('./components/book41/Book41Ch9'));
const Book41Ch10 = lazyWithRetry(() => import('./components/book41/Book41Ch10'));
const Book41Ch11 = lazyWithRetry(() => import('./components/book41/Book41Ch11'));
const Book41Ch12 = lazyWithRetry(() => import('./components/book41/Book41Ch12'));
const Book41Ch13 = lazyWithRetry(() => import('./components/book41/Book41Ch13'));
const Book41Ch14 = lazyWithRetry(() => import('./components/book41/Book41Ch14'));
const Book41Ch15 = lazyWithRetry(() => import('./components/book41/Book41Ch15'));
const Book41Ch16 = lazyWithRetry(() => import('./components/book41/Book41Ch16'));
const Book41Ch17 = lazyWithRetry(() => import('./components/book41/Book41Ch17'));
const Book41Ch18 = lazyWithRetry(() => import('./components/book41/Book41Ch18'));
const Book41Ch19 = lazyWithRetry(() => import('./components/book41/Book41Ch19'));
const Book41Ch20 = lazyWithRetry(() => import('./components/book41/Book41Ch20'));
const Book41Ch21 = lazyWithRetry(() => import('./components/book41/Book41Ch21'));
const Book41Ch22 = lazyWithRetry(() => import('./components/book41/Book41Ch22'));
const Book41Ch23 = lazyWithRetry(() => import('./components/book41/Book41Ch23'));
const Book41Ch24 = lazyWithRetry(() => import('./components/book41/Book41Ch24'));
const Book41Ch25 = lazyWithRetry(() => import('./components/book41/Book41Ch25'));
const Book41Ch26 = lazyWithRetry(() => import('./components/book41/Book41Ch26'));
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/book33/chapter5" element={<BookLayout bookId="book33" chapter="chapter5" chapters={getChaptersForBook('book33')}><Book33Ch5 /></BookLayout>} />
        <Route path="/book33/chapter6" element={<BookLayout bookId="book33" chapter="chapter6" chapters={getChaptersForBook('book33')}><Book33Ch6 /></BookLayout>} />
        <Route path="/book33/conclusion" element={<BookLayout bookId="book33" chapter="conclusion" chapters={getChaptersForBook('book33')}><Book33Conclusion /></BookLayout>} />
        <Route path="/book33/bibliography" element={<BookLayout bookId="book33" chapter="bibliography" chapters={getChaptersForBook('book33')}><Book33Bibliography /></BookLayout>} />
        ...
        <Route path="/book34/chapter2" element={<BookLayout bookId="book34" chapter="chapter2" chapters={getChaptersForBook('book34')}><Book34Ch2 /></BookLayout>} />
        <Route path="/book34/chapter3" element={<BookLayout bookId="book34" chapter="chapter3" chapters={getChaptersForBook('book34')}><Book34Ch3 /></BookLayout>} />
        <Route path="/book34/chapter4" element={<BookLayout bookId="book34" chapter="chapter4" chapters={getChaptersForBook('book34')}><Book34Ch4 /></BookLayout>} />
        <Route path="/book34/chapter5" element={<BookLayout bookId="book34" chapter="chapter5" chapters={getChaptersForBook('book34')}><Book34Ch5 /></BookLayout>} />
        <Route path="/book34/chapter6" element={<BookLayout bookId="book34" chapter="chapter6" chapters={getChaptersForBook('book34')}><Book34Ch6 /></BookLayout>} />
        <Route path="/book34/chapter7" element={<BookLayout bookId="book34" chapter="chapter7" chapters={getChaptersForBook('book34')}><Book34Ch7 /></BookLayout>} />
        <Route path="/book34/chapter8" element={<BookLayout bookId="book34" chapter="chapter8" chapters={getChaptersForBook('book34')}><Book34Ch8 /></BookLayout>} />
        <Route path="/book34/chapter9" element={<BookLayout bookId="book34" chapter="chapter9" chapters={getChaptersForBook('book34')}><Book34Ch9 /></BookLayout>} />
        <Route path="/book34/chapter10" element={<BookLayout bookId="book34" chapter="chapter10" chapters={getChaptersForBook('book34')}><Book34Ch10 /></BookLayout>} />
        <Route path="/book34/chapter11" element={<BookLayout bookId="book34" chapter="chapter11" chapters={getChaptersForBook('book34')}><Book34Ch11 /></BookLayout>} />
        <Route path="/book34/chapter12" element={<BookLayout bookId="book34" chapter="chapter12" chapters={getChaptersForBook('book34')}><Book34Ch12 /></BookLayout>} />
        <Route path="/book34/chapter13" element={<BookLayout bookId="book34" chapter="chapter13" chapters={getChaptersForBook('book34')}><Book34Ch13 /></BookLayout>} />
        <Route path="/book34/chapter14" element={<BookLayout bookId="book34" chapter="chapter14" chapters={getChaptersForBook('book34')}><Book34Ch14 /></BookLayout>} />
        <Route path="/book34/chapter15" element={<BookLayout bookId="book34" chapter="chapter15" chapters={getChaptersForBook('book34')}><Book34Ch15 /></BookLayout>} />
        ...
        <Route path="/book37/home" element={<BookLayout bookId="book37" chapter="home" chapters={getChaptersForBook('book37')}><Book37Home /></BookLayout>} />
        <Route path="/book37/preface" element={<BookLayout bookId="book37" chapter="preface" chapters={getChaptersForBook('book37')}><Book37Preface /></BookLayout>} />
        <Route path="/book37/chapter1" element={<BookLayout bookId="book37" chapter="chapter1" chapters={getChaptersForBook('book37')}><Book37Ch1 /></BookLayout>} />
        <Route path="/book37/chapter2" element={<BookLayout bookId="book37" chapter="chapter2" chapters={getChaptersForBook('book37')}><Book37Ch2 /></BookLayout>} />
        <Route path="/book37/chapter3" element={<BookLayout bookId="book37" chapter="chapter3" chapters={getChaptersForBook('book37')}><Book37Ch3 /></BookLayout>} />
        <Route path="/book37/chapter4" element={<BookLayout bookId="book37" chapter="chapter4" chapters={getChaptersForBook('book37')}><Book37Ch4 /></BookLayout>} />
        <Route path="/book37/chapter5" element={<BookLayout bookId="book37" chapter="chapter5" chapters={getChaptersForBook('book37')}><Book37Ch5 /></BookLayout>} />
        <Route path="/book/37" element={<BookLayout bookId="book37" chapter="home" chapters={getChaptersForBook('book37')}><Book37Home /></BookLayout>} />
        <Route path="/book38/home" element={<BookLayout bookId="book38" chapter="home" chapters={getChaptersForBook('book38')}><Book38Home /></BookLayout>} />
        <Route path="/book38/preface" element={<BookLayout bookId="book38" chapter="preface" chapters={getChaptersForBook('book38')}><Book38Preface /></BookLayout>} />
        <Route path="/book38/chapter1" element={<BookLayout bookId="book38" chapter="chapter1" chapters={getChaptersForBook('book38')}><Book38Ch1 /></BookLayout>} />
        <Route path="/book38/chapter2" element={<BookLayout bookId="book38" chapter="chapter2" chapters={getChaptersForBook('book38')}><Book38Ch2 /></BookLayout>} />
        <Route path="/book38/chapter3" element={<BookLayout bookId="book38" chapter="chapter3" chapters={getChaptersForBook('book38')}><Book38Ch3 /></BookLayout>} />
        <Route path="/book38/chapter4" element={<BookLayout bookId="book38" chapter="chapter4" chapters={getChaptersForBook('book38')}><Book38Ch4 /></BookLayout>} />
        <Route path="/book38/chapter5" element={<BookLayout bookId="book38" chapter="chapter5" chapters={getChaptersForBook('book38')}><Book38Ch5 /></BookLayout>} />
        <Route path="/book38/chapter6" element={<BookLayout bookId="book38" chapter="chapter6" chapters={getChaptersForBook('book38')}><Book38Ch6 /></BookLayout>} />
        <Route path="/book38/chapter7" element={<BookLayout bookId="book38" chapter="chapter7" chapters={getChaptersForBook('book38')}><Book38Ch7 /></BookLayout>} />
        <Route path="/book38/chapter8" element={<BookLayout bookId="book38" chapter="chapter8" chapters={getChaptersForBook('book38')}><Book38Ch8 /></BookLayout>} />
        <Route path="/book38/chapter9" element={<BookLayout bookId="book38" chapter="chapter9" chapters={getChaptersForBook('book38')}><Book38Ch9 /></BookLayout>} />
        <Route path="/book38/chapter10" element={<BookLayout bookId="book38" chapter="chapter10" chapters={getChaptersForBook('book38')}><Book38Ch10 /></BookLayout>} />
        <Route path="/book38/chapter11" element={<BookLayout bookId="book38" chapter="chapter11" chapters={getChaptersForBook('book38')}><Book38Ch11 /></BookLayout>} />
        <Route path="/book38/chapter12" element={<BookLayout bookId="book38" chapter="chapter12" chapters={getChaptersForBook('book38')}><Book38Ch12 /></BookLayout>} />
        <Route path="/book38/chapter13" element={<BookLayout bookId="book38" chapter="chapter13" chapters={getChaptersForBook('book38')}><Book38Ch13 /></BookLayout>} />
        <Route path="/book/38" element={<BookLayout bookId="book38" chapter="home" chapters={getChaptersForBook('book38')}><Book38Home /></BookLayout>} />
        <Route path="/book39/home" element={<BookLayout bookId="book39" chapter="home" chapters={getChaptersForBook('book39')}><Book39Home /></BookLayout>} />
        ...
        <Route path="/book39/chapter5" element={<BookLayout bookId="book39" chapter="chapter5" chapters={getChaptersForBook('book39')}><Book39Ch5 /></BookLayout>} />
        <Route path="/book39/chapter6" element={<BookLayout bookId="book39" chapter="chapter6" chapters={getChaptersForBook('book39')}><Book39Ch6 /></BookLayout>} />
        <Route path="/book39/chapter7" element={<BookLayout bookId="book39" chapter="chapter7" chapters={getChaptersForBook('book39')}><Book39Ch7 /></BookLayout>} />
        <Route path="/book39/chapter8" element={<BookLayout bookId="book39" chapter="chapter8" chapters={getChaptersForBook('book39')}><Book39Ch8 /></BookLayout>} />
        <Route path="/book39/chapter9" element={<BookLayout bookId="book39" chapter="chapter9" chapters={getChaptersForBook('book39')}><Book39Ch9 /></BookLayout>} />
        <Route path="/book39/chapter10" element={<BookLayout bookId="book39" chapter="chapter10" chapters={getChaptersForBook('book39')}><Book39Ch10 /></BookLayout>} />
        <Route path="/book39/chapter11" element={<BookLayout bookId="book39" chapter="chapter11" chapters={getChaptersForBook('book39')}><Book39Ch11 /></BookLayout>} />
        <Route path="/book39/chapter12" element={<BookLayout bookId="book39" chapter="chapter12" chapters={getChaptersForBook('book39')}><Book39Ch12 /></BookLayout>} />
        <Route path="/book39/chapter13" element={<BookLayout bookId="book39" chapter="chapter13" chapters={getChaptersForBook('book39')}><Book39Ch13 /></BookLayout>} />
        <Route path="/book39/chapter14" element={<BookLayout bookId="book39" chapter="chapter14" chapters={getChaptersForBook('book39')}><Book39Ch14 /></BookLayout>} />
        ...
        <Route path="/book40/chapter3" element={<BookLayout bookId="book40" chapter="chapter3" chapters={getChaptersForBook('book40')}><Book40Ch3 /></BookLayout>} />
        <Route path="/book40/chapter4" element={<BookLayout bookId="book40" chapter="chapter4" chapters={getChaptersForBook('book40')}><Book40Ch4 /></BookLayout>} />
        <Route path="/book40/chapter5" element={<BookLayout bookId="book40" chapter="chapter5" chapters={getChaptersForBook('book40')}><Book40Ch5 /></BookLayout>} />
        <Route path="/book40/chapter6" element={<BookLayout bookId="book40" chapter="chapter6" chapters={getChaptersForBook('book40')}><Book40Ch6 /></BookLayout>} />
        <Route path="/book40/chapter7" element={<BookLayout bookId="book40" chapter="chapter7" chapters={getChaptersForBook('book40')}><Book40Ch7 /></BookLayout>} />
        <Route path="/book40/chapter8" element={<BookLayout bookId="book40" chapter="chapter8" chapters={getChaptersForBook('book40')}><Book40Ch8 /></BookLayout>} />
        <Route path="/book40/chapter9" element={<BookLayout bookId="book40" chapter="chapter9" chapters={getChaptersForBook('book40')}><Book40Ch9 /></BookLayout>} />
        <Route path="/book40/chapter10" element={<BookLayout bookId="book40" chapter="chapter10" chapters={getChaptersForBook('book40')}><Book40Ch10 /></BookLayout>} />
        <Route path="/book40/chapter11" element={<BookLayout bookId="book40" chapter="chapter11" chapters={getChaptersForBook('book40')}><Book40Ch11 /></BookLayout>} />
        <Route path="/book40/chapter12" element={<BookLayout bookId="book40" chapter="chapter12" chapters={getChaptersForBook('book40')}><Book40Ch12 /></BookLayout>} />
        <Route path="/book40/chapter13" element={<BookLayout bookId="book40" chapter="chapter13" chapters={getChaptersForBook('book40')}><Book40Ch13 /></BookLayout>} />
        <Route path="/book40/chapter14" element={<BookLayout bookId="book40" chapter="chapter14" chapters={getChaptersForBook('book40')}><Book40Ch14 /></BookLayout>} />
        <Route path="/book40/chapter15" element={<BookLayout bookId="book40" chapter="chapter15" chapters={getChaptersForBook('book40')}><Book40Ch15 /></BookLayout>} />
        <Route path="/book40/chapter16" element={<BookLayout bookId="book40" chapter="chapter16" chapters={getChaptersForBook('book40')}><Book40Ch16 /></BookLayout>} />
        ...
        <Route path="/book41/chapter7" element={<BookLayout bookId="book41" chapter="chapter7" chapters={getChaptersForBook('book41')}><Book41Ch7 /></BookLayout>} />
        <Route path="/book41/chapter8" element={<BookLayout bookId="book41" chapter="chapter8" chapters={getChaptersForBook('book41')}><Book41Ch8 /></BookLayout>} />
        <Route path="/book41/chapter9" element={<BookLayout bookId="book41" chapter="chapter9" chapters={getChaptersForBook('book41')}><Book41Ch9 /></BookLayout>} />
        <Route path="/book41/chapter10" element={<BookLayout bookId="book41" chapter="chapter10" chapters={getChaptersForBook('book41')}><Book41Ch10 /></BookLayout>} />
        <Route path="/book41/chapter11" element={<BookLayout bookId="book41" chapter="chapter11" chapters={getChaptersForBook('book41')}><Book41Ch11 /></BookLayout>} />
        <Route path="/book41/chapter12" element={<BookLayout bookId="book41" chapter="chapter12" chapters={getChaptersForBook('book41')}><Book41Ch12 /></BookLayout>} />
        <Route path="/book41/chapter13" element={<BookLayout bookId="book41" chapter="chapter13" chapters={getChaptersForBook('book41')}><Book41Ch13 /></BookLayout>} />
        <Route path="/book41/chapter14" element={<BookLayout bookId="book41" chapter="chapter14" chapters={getChaptersForBook('book41')}><Book41Ch14 /></BookLayout>} />
        <Route path="/book41/chapter15" element={<BookLayout bookId="book41" chapter="chapter15" chapters={getChaptersForBook('book41')}><Book41Ch15 /></BookLayout>} />
        <Route path="/book41/chapter16" element={<BookLayout bookId="book41" chapter="chapter16" chapters={getChaptersForBook('book41')}><Book41Ch16 /></BookLayout>} />
        <Route path="/book41/chapter17" element={<BookLayout bookId="book41" chapter="chapter17" chapters={getChaptersForBook('book41')}><Book41Ch17 /></BookLayout>} />
        <Route path="/book41/chapter18" element={<BookLayout bookId="book41" chapter="chapter18" chapters={getChaptersForBook('book41')}><Book41Ch18 /></BookLayout>} />
        <Route path="/book41/chapter19" element={<BookLayout bookId="book41" chapter="chapter19" chapters={getChaptersForBook('book41')}><Book41Ch19 /></BookLayout>} />
        <Route path="/book41/chapter20" element={<BookLayout bookId="book41" chapter="chapter20" chapters={getChaptersForBook('book41')}><Book41Ch20 /></BookLayout>} />
        <Route path="/book41/chapter21" element={<BookLayout bookId="book41" chapter="chapter21" chapters={getChaptersForBook('book41')}><Book41Ch21 /></BookLayout>} />
        <Route path="/book41/chapter22" element={<BookLayout bookId="book41" chapter="chapter22" chapters={getChaptersForBook('book41')}><Book41Ch22 /></BookLayout>} />
        <Route path="/book41/chapter23" element={<BookLayout bookId="book41" chapter="chapter23" chapters={getChaptersForBook('book41')}><Book41Ch23 /></BookLayout>} />
        <Route path="/book41/chapter24" element={<BookLayout bookId="book41" chapter="chapter24" chapters={getChaptersForBook('book41')}><Book41Ch24 /></BookLayout>} />
        <Route path="/book41/chapter25" element={<BookLayout bookId="book41" chapter="chapter25" chapters={getChaptersForBook('book41')}><Book41Ch25 /></BookLayout>} />
        <Route path="/book41/chapter26" element={<BookLayout bookId="book41" chapter="chapter26" chapters={getChaptersForBook('book41')}><Book41Ch26 /></BookLayout>} />
