...
export const BOOK_CHAPTERS: Record<string, ChapterInfo[]> = {
  ...
  book41: [
    ...
    { id: 'chapter27', title: '第四部 4-1　融入榮辱感於目標中', path: '/book41/chapter27' },
...
const Book41Ch27 = lazyWithRetry(() => import('./components/book41/Book41Ch27'));
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/book41/chapter27" element={<BookLayout bookId="book41" chapter="chapter27" chapters={getChaptersForBook('book41')}><Book41Ch27 /></BookLayout>} />
