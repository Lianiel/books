          ...
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  創世記九5的「討」，原文דָּרַשׁ（darash），有追討、尋索罪責的意思。這個字在原文共出現三次，中文聖經只翻譯出一次，全部譯出來是：「流你們血、害你們命的，我必追討：無論是獸是人，我必追討，就是向各人的弟兄也必追討他的命。」神三次講追討，表示必定執行。人應透過法律執行，不然神也會自己執行。因為這是對人生命權的尊重與保護。
                </p>
                <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-col items-center my-4">
                  <img
                    src="/images/book29/ch38-rainbow-covenant.png"
                    alt="圖十三：神以彩虹立約，挪亞舉手向天敬拜，天空出現彩虹"
                    className="max-w-full h-auto rounded-lg shadow-md border border-gray-200"
                  />
                  <p className="text-sm text-gray-500 mt-2 italic">圖十三：神以彩虹立約</p>
                </div>

                <p className="text-gray-700 leading-relaxed">
                  中國古書《淮南子・覽冥篇》講到：「女媧熔煉五色石，以補蒼天。」意思是，蒼天有破洞，造成洪水，女媧用顏色如同彩虹的五色石來補蒼天的破洞，從此之後天上就有了彩虹。這雖是個傳說，但很可能是從歷史事實演變而來的。大洪水退後，上帝與挪亞立約，以彩虹為記號。是上帝將彩虹放在天空作為立約記號，應許不再以洪水毀滅世界，立約之後才有了彩虹。「挪亞」的希伯來文נֹחַ（Noach）跟中文「女媧」的古音幾乎一樣，並且傳說中女媧是天下人的祖先，挪亞也真的是目前全天下人的祖先，由此可知女媧的傳說跟挪亞是有關連的。
                </p>
              </div>
            </div>
