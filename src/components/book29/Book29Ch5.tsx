        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                以創世記一6-8為例，可改譯為「空間」，但不可改譯為「穹蒼」，因為是一個廣闊的空間把水分為上下，而不是穹蒼把水分開。若穹蒼之上有水，那水就是在外太空，這完全不是神的意思。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                而在14-20節，則是在講外太空，所以在 רָקִיעַ（raqiya）這個字的後面都附加說明是在「天上，שָׁמַיִם，shamayim」，一14直譯：「神說，天上的空間要有光體。……」一17直譯：「就把這些光擺列在天上的空間，普照在地上。」但新譯本卻翻譯為「天上的穹蒼」，這是不恰當的。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                神的話本來就很清楚，創世記一6-8是在講地球範圍的空間，所以只講 רָקִיעַ（raqiya），創世記一14-20是在講地球之上的空間，所以除了講 רָקִיעַ（raqiya），又加「天上，שָׁמַיִם，shamayim」來界定。而穹蒼乃是那個像圓頂的東西，上面有日、月、星，是人的視覺效果，並不能區分為地上的穹蒼與天上的穹蒼。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                詩篇十九1：「諸天述說神的榮耀；穹蒼傳揚他的手段。」穹蒼與諸天對應，若譯為「天空」，也很通順。詩篇一五○1：「你們要讚美耶和華！在神的聖所讚美他！在他顯能力的穹蒼讚美他！」此處穹蒼譯為天空也沒問題。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                創世記一6-7：「神說，諸水之間要有空氣，將水分為上下。神就造出空氣……」一般認為，在創世記第一章，神用「說」來造，這只是一個角度而已。第一日神造光是這樣沒錯，但第二日神造空氣，第四日神造光體，第五日神造水中活物與空中飛鳥，第六日神造陸上動物、造人，都是先說了之後，又有造的行動。「神先說，而後神工作」乃是更通常的模式。這表明，神若說了，他一定會去做，這是神的信實。<sup>1</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（紀博遜，《創世記注釋上冊》，頁49-51）</span>在後來神與人的互動中，神常常先應許，或先預言，而後成就。並且很多時候，神希望人以禱告與神同工，而後神會動工。有一個鮮明的例子是，但以理從書上得知神的話論耶路撒冷荒涼的年數，七十年為滿。就去禁食禱告，懇求神成就這事。後來神也如此成就（但九1-19，代下卅六22-23）。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                這個天上的水，水量豐沛，可供應乾淨的飲用水，因海水不能喝，天上的水下來，才合適人喝，那是淡水。當然地下水也有淡水，但大洪水前至少一千多年當中，一定也需要藉蒸發作用產生的水循環，使天上的水供應下來。天上的水（氣）層可保護地球，抵擋不好的宇宙射線、過量的太陽紫外線等。天上的水（氣）層還可以調節全地的溫度，本來地球上沒有極端的氣候，北極是溫暖的，赤道也不會太熱，全地像是一個大的伊甸園。目前從北極可挖出冰凍的長毛象，根據牠的皮下組織及胃裡的食物，可推知牠是溫帶動物。但洪水來臨時，水（氣）層破了，有一個快速的過程，讓北極立即變成極冷，長毛象很快被冷凍，可詳見孫大程博士的分析。<sup>2</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（孫大程，《創世以來的奧秘》，頁193-195）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
