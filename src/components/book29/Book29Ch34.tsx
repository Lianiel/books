        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                「造」這個字，神造天地（創二4）、造一個配偶（創二18），都用這個字。不僅神能造，神也賦予他所造的人有造的能力，所以神要挪亞造方舟。但這件事不僅需要能力，也需要順服，22節兩次講到挪亞就這樣行、照樣行，充分描繪出挪亞順服的態度。這是人與神同工應有的樣式，正如耶穌基督在世上事奉的態度：「耶穌對他們說：我實實在在的告訴你們，子憑著自己不能做甚麼，唯有看見父所做的，子纔能做；父所做的事，子也照樣做。」（約五19）<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《始於神──創世記靈修日引》，2月15日）</span>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                洪水後的民生科技可以發展得很快速，可能因為挪亞全家有把一些科技傳承到新的世界，而不是全部從頭摸索。有件事可作為佐證，就是洪水後不久，人們齊心建造巴別塔，那會需要用到不少科技。挪亞所做的事超過一般人的想像，他把全家人帶到新世界，他把創世記一至八章所有的故事與啟示帶到新世界，他把各種有用的藝術、科技帶到新世界，以至於人們能知道整個創造、墮落、拯救的故事，也能快速發展新世代的文明。另一個聖經之外的佐證是，中華民族古老的文明並不需要漫長時間的發展，因為有挪亞、閃的傳遞，福音信仰與民生科技都在神州大地快速生根發展。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（莊東傑，《跨越鴻溝》，頁183-184；《華人回家》，頁11-12）</span>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                生物學家統計，動物種類共有一百多萬種，但大部分是海生動物，需要靠方舟才能存活的只有哺乳類3500種，鳥類8800種，爬蟲及兩棲類5500種，昆蟲25500種。昆蟲的種類多沒關係，因牠們體積小，佔不了多少空間。這些動物每種都成對計算，最多是大約35000隻羊的體積，僅需一列150節車廂的火車就足夠了，因此載貨量超過520節車廂的方舟，還有很多其他空間可以存放食物及做一些活動。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（威明頓，《威明頓聖經輔讀（卷上）》，頁63）</span>
              </p>
              <p className="text-gray-700 leading-relaxed">
