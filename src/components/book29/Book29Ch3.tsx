        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                創世記一2的「是」，希伯來文是 הָיָה（hayah），可以翻譯作「是，be」或「成了，become」。創世記二7的「成了」，及創世記十九26的「變成」在原文都是這個字。所以重造論（又稱時溝論）的學者，認為應該翻譯為「地變成了空虛混沌」。這些學者認為是天使叛變，引致審判，地才變成空虛渾沌，這樣的解釋可以與進化論的地質時代相容。但這樣解釋的根據並不充分。這個字比較多的時候，翻譯作「是」，而且整本聖經對於「重造」這麼重要的事完全沒有提及。再一個是文法上的理由，黃儀章指出，創世記一2乃是情況子句，而非次序子句，所以不是描述地變成甚麼，而是在講完神創造天地後，接著講地是怎樣的情況。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（黃儀章，《創造、立約與復和》，頁80-83）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                空虛的原文 תֹּהוּ（tohuw），英文是 vain，指沒有形狀、虛無，舊約聖經出現20次，大體都是這個意思。混沌的原文 בֹּהוּ（bohuw），英文是 void，是空洞、荒蕪的意思，在舊約聖經僅出現3次。這兩個字的意思很接近，希伯來文的發音也很相似，產生一種加乘共鳴的效果，讓人感覺真的非常空洞虛無。舊約學者約翰華頓指出，空虛渾沌不是沒有東西，而是沒有次序。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（中華福音神學院編，《創世記1-11章》〔約翰·華頓研習會講義〕，頁4-5）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                重造論者認為這是審判後的結果，因為以賽亞書卅四11，耶利米書四23講審判後的光景，都用空虛混沌來形容。雖然如此，也可以解釋說，審判後地變成好像剛被創造時空虛渾沌的樣子，並非一定要將空虛混沌解釋為審判後的光景。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                空虛渾沌應該是創造過程中的第一階段，如同建造聖殿的工地，在聖殿建造好之後是很榮耀的，但在起頭的時候，僅有一些材料在地上，感覺是空洞混亂的。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（陳志宏，〈起初，上帝創造天地〉，《中華福音神學院院訊573期（2018.7）》，頁3）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                黑暗的原文是 חֹשֶׁךְ（choshek），英文 darkness，意思是黑暗，也可以是隱密處。一般認為黑暗代表罪惡，但黑暗也可以代表神工作的前兆，黑暗也是神藏身之處<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（陳志宏，〈起初，上帝創造天地〉，《中華福音神學院院訊573期（2018.7）》，頁2）</span>，如下列經文所呈現。申命記四11：「那時你們近前來，站在山下；山上有火焰沖天，並有昏黑、密雲、幽暗。」申命記五23：「那時，火焰燒山，你們聽見從黑暗中出來的聲音；你們支派中所有的首領和長老都來就近我，」詩篇十八11：「他以黑暗為藏身之處，以水的黑暗、天空的厚雲為他四圍的行宮。」
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                神的靈應該是有位格的聖靈，三位一體神的第三位。靈這個字，在希伯來文與風是同一個字 רוּחַ（ruach），神 אֱלֹהִים（elohim），這個字也有能力的意思，因此似乎也可以理解為神的風，或強大的風<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（艾倫·羅斯，《創造與祝福——創世記註釋與信息》，頁131）</span>，某些聖經版本採取這種翻譯<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（紀博遜，《創世記注釋上冊》，頁19）</span>。然而從整本聖經的啟示，翻譯為神的靈是最恰當的，因為聖靈真的參與在創造的工作裡，這在本書第二章已有相關的說明。並且，接著的動詞「運行」並不適用於描述風在吹盪，但適用於描述聖靈。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（黃儀章，《舊約神學——從創造到新創造》，頁39-40）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                「運行」的原文是 רָחַף（rachaph），可以譯作運行或盤旋，有覆翼、保護的意思。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《始於神——創世記靈修日引》，頁1月1日）</span>這個字在舊約只有出現三次（創一2，申卅二11，耶廿三9），其中這字在申命記卅二11與在創世記一2的文法詞性是相同的，申命記卅二11：「又如鷹攪動巢窩，在雛鷹以上兩翅搧展，接取雛鷹，背在兩翼之上。」其中的「搧」就是 רָחַף（rachaph）這個字。藉此可看出，「運行」不是靜態的，乃是動態的。一方面好像母雞孵小雞，神的靈在做「孵育」的工作，預備地球上將產生新的生命<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（紀博遜，《創世記注釋上冊》，頁41-42）</span>；另一方面好像老鷹搧展牠的翅膀，要使雛鷹進入牠下一階段的成長過程。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（艾倫·羅斯，《創造與祝福——創世記註釋與信息》，頁131。亞金森，《創世記1~11章》，頁25）</span>這與我們的代禱工作相似，當我們為一個人或一個城市、國家代禱，神的靈就開始運行其上，而後產生改變，孕育出新的屬靈生命。新約時代，五旬節那天，聖靈降臨，那是因為門徒們照著耶穌的吩咐，十天之久同心合意禱告等候聖靈。以後神的靈繼續運行在耶路撒冷，使耶路撒冷不斷有人歸主得救，同時間耶路撒冷教會的禱告沒有止息，門徒們在殿中、家中都同心合意禱告。這正是禱告與聖靈工作的關聯性，從第一世紀到今天都是這個原則，哪裡有同心合意地禱告，哪裡就有聖靈的工作，並使人得著新生命，帶來屬靈的復興。
              </p>
