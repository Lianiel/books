  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-1"><sup>20</sup>神說：水要多多滋生有生命的物；要有雀鳥飛在地面以上，天空之中。<sup>21</sup>神就造出大魚和水中所滋生各樣有生命的動物，各從其類；又造出各樣飛鳥，各從其類。神看著是好的。<sup>22</sup>神就賜福給這一切，說：滋生繁多，充滿海中的水；雀鳥也要多生在地上。<sup>23</sup>有晚上，有早晨，是第五日　創世記一20-23</p>
      </div>
        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                神在六日的創造中，只有第五日吩咐魚、鳥要多生，充滿海，遍滿地，以及第六日吩咐人要生養眾多，遍滿全地。對魚的祝福：滋生繁多，充滿海中的水；（22b）對雀鳥的祝福：雀鳥也要多生在地上。（22c）對人的祝福：神就賜福給他們，又對他們說：要生養眾多，遍滿地面，治理這地，也要管理海裡的魚、空中的鳥，和地上各樣行動的活物。（28節）這代表神特別欣賞水中游的魚，及空中飛的鳥。因為魚、鳥所代表的有安息的生命，乃是神所喜悅的生命。
              </p>
