        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                長壽者瑪土撒拉是一個承先啟後的人，他可以同時向他的七代前輩學習：亞當、塞特、以挪士、該南、瑪勒列、雅列、以諾<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（禰浩榮，《挪亞方舟與滅世洪水》，頁70）</span>。他的前半生，這七位前輩都還在，而他的後半生，則一直幫助、守望著後面三代，也是洪水前的最後三代。其中最特別的是他的孫子挪亞，拉麥「生了一個兒子，給他起名叫挪亞，說：這個兒子必為我們的操作和手中的勞苦安慰我們；這操作勞苦是因為耶和華咒詛地。」
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                從亞當到他的十世孫挪亞，他們的希伯來文名字各有其意義，與本人的特質或使命有關，連起來看，似乎有一個特別的啟示<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（樸潤植，《從神救贖史的經綸看創世記的家譜》，頁113-154）</span>：亞當：人。塞特：被註定，被指派。以挪士：軟弱的，不免一死的。該南：意外得到憐恤。瑪勒列：可稱頌的神。雅列：降下的人。以諾：教師、被獻的人。瑪土撒拉：他的死將帶給。拉麥：剛強的人、禱告的人。挪亞：安慰、安息。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
