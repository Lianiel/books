        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                吳勇長老末期癌症得醫治，是全然的神蹟。這事好像違反科學，其實是超越科學。基督徒對待科學的態度，要如同對待金錢，可以使用它正面的好處，而不受到它的限制。正確的科學，屬於神的左手；而超自然神蹟乃是神的右手<sup>1</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（保羅·阿爾托依茲，《馬丁路德神學》，頁38）</span>，我們要同時活在神的左手與右手之中。
              </p>
              <p className="text-gray-700 leading-relaxed">
                回來談創世的時間起點，根據舊約聖經所記載各人的年齡及歷史上可確定的時間，推算大約在六千多年前，但因為有長子、非長子的年代差距，還有家譜可能省略，有些年代可能遺漏計算。所以地球真正的年齡會更長一些，但可能不到一萬歲。科學上也有許多證據，可以說明地球是年輕的，這方面請參看孫大程博士所寫的《創世以來的奧秘》這本書。那裡提供不少資料，讓我們知道地球、宇宙都是年輕的。<sup>2</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（孫大程，《創世以來的奧秘》，頁29-38）</span>本書末尾附錄六、附錄七是筆者曾經在基督教論壇報發表過的兩篇文章，也提供有關地球年輕的論說。
              </p>
            </div>
