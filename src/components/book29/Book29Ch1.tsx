          ...
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                創世記是全本聖經的種籽書，創世記一章（至二章3節）也是全卷創世記的種籽，二章1-3節歸為第一章會比較合理，因為這個範圍是講完整的七日，包含「從創造到安息」的完整內容。謝挺博士認為創造的總結是神安息<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《創世記（上）從創造到揀選》，頁52）</span>，這事實不僅符合創造週，也符合全卷創世記，並符合整本聖經，因為創世記的內容正是從創造到安息，全本聖經的內容也是從創造到安息。那安息是終末的目標，是神一切工作的完成。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                創世記一章至二章3節包含八個小段落，是與創造過程相關的八個階段，其中第一階段的起初，與最後階段的安息相對應，其時間長度比較不明確，同樣沒有講「有晚上有早晨」；神創造的前三日是開展背景，創造居住的層面及供應者（光、水、空氣、陸地、植物）；神創造的後三日是充實舞台，創造居住者、管理者（日月星、魚、鳥、陸上活物、人）。神在他的創造裡不斷增加顏色。從第一日的黑夜與白日，到第二日的藍天與海，到第三日的綠草、菜蔬和結果子的樹木，再加上以後金黃色的太陽和紅潤的人類，就形成彩虹的顏色了。神不僅是創造者，也是藝術家。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《創世記（上）從創造到揀選》，頁36-45）</span>
              </p>
              ...
              <table border={1} cellPadding={0} cellSpacing={0} className="w-full border border-indigo-200 rounded-lg overflow-hidden my-4 border-collapse" style={{ fontSize: 'calc(1em - 8px)' }}>
                <tbody>
                  <tr>
                    <td colSpan={4} className="text-center font-semibold bg-indigo-100 text-indigo-900 py-2 border border-indigo-200">表二：神創造工作的次序與內涵</td>
                  </tr>
                  <tr>
                    <td colSpan={4} className="text-center text-gray-700 py-2 bg-white border border-indigo-200">起初：神創造天地，地是空虛混沌，淵面黑暗</td>
                  </tr>
                  <tr className="text-center font-semibold text-indigo-800 bg-indigo-50">
                    <td colSpan={2} className="py-2 border border-indigo-200">頭三天：創造居住的層面<br />開展背景，預備供應者</td>
                    <td colSpan={2} className="py-2 border border-indigo-200">後三天：創造居住者<br />充實舞台，創造管理者</td>
                  </tr>
                  <tr className="text-center font-semibold text-gray-600 bg-indigo-50/60">
                    <td className="py-1.5 border border-indigo-200">日期</td>
                    <td className="py-1.5 border border-indigo-200">神的工作</td>
                    <td className="py-1.5 border border-indigo-200">日期</td>
                    <td className="py-1.5 border border-indigo-200">神的工作</td>
                  </tr>
                  {[
                    ...
                    <tr key={i} className="text-center text-gray-700 bg-white">
                      <td className="py-2 border border-indigo-200 font-semibold">{row[0]}</td>
                      <td className="py-2 border border-indigo-200 whitespace-pre-line">{row[1]}</td>
                      <td className="py-2 border border-indigo-200 font-semibold">{row[2]}</td>
                      <td className="py-2 border border-indigo-200 whitespace-pre-line">{row[3]}</td>
                    </tr>
                  ))}
                  <tr>
                    <td colSpan={4} className="text-center text-gray-700 py-2 bg-indigo-50 border border-indigo-200">第七日：安息</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                「起初」（רֵאשִׁית，reshiyth）神創造天地，希伯來文 רֵאשִׁית（reshiyth）這個字可以翻譯作「起初」或「首先」。這個字有兩個特點，一個特點是往往指著一段伸展但不確定的時間，而非一個特定的時刻<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（黃儀章，《舊約神學——從創造到新創造》，頁17）</span>。另一個特點是「起初」這個字有一個配語：「末後」<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（陳錦友，《女人後裔的應許——神宏大救贖故事的序幕（創一至十一章）》，頁12-13）</span>；或者說，這字有一個相連而對立的字，是「末後」。中文也有配語，例如「雖然」的配語是「但是」，若出現「雖然」，下一句就會出現「但是」。同樣，在希伯來文這個字，既有了「起初」，就會有「末後」。例如，約伯記八7：「你起初雖然微小，終久必甚發達。」這節經文顯出了上述這兩個特點。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                「起初」神創造了宇宙，不僅指出宇宙有其開始，聖經作者亦暗示在歷史所向之處有一「終末」。當希伯來讀者讀到創世記一章一節的時候，同時就會留意這世界的終末<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（黃儀章，《舊約神學——從創造到新創造》，頁25）</span>。另外有兩個關於「開始」的字，是對應於第二或下一個，但聖經作者特別選用對應於「終末」的字「רֵאשִׁית（reshiyth）」。所以，這將帶出一個有終末性教義的創造論。如同一個人的生命是一個朝聖的進程，世界的歷史由創世開始就被理解成一個目的性的運動，引向終末的新天新地（賽六十五17，啟廿一1）<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（黃儀章，《舊約神學——從創造到新創造》，頁26）</span>。創世記一至二章所記載的，將會在末日重現，那就是啟示錄廿一、廿二章所寫的新天新地。這是聖經啟示的宇宙觀，是直線的，有一個完滿的結束；有別於佛教的宇宙觀是圓形循環的，沒有開始，也沒有結束。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                按照「千禧年前派」的理解（這也是筆者的立場），這個世代結束前會有一個普世性的大災難，人類多數在這場大災難中死亡之後開啟千禧年國度。基督徒或得勝者有的復活，有的被提，與基督一同作王一千年，大災難的餘民及後裔將成為禧年國度的百姓。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（莊東傑，《啟示錄的4個旋律》，頁435-436）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed">
                希伯來文的「בְּרֵאשִׁית（Bereshiyth，在起初）」，七十士譯本的希臘文是「Ἐν ἀρχῇ（En arche）」，約翰福音一1也用了完全一樣的「Ἐν ἀρχῇ（En arche）」。為何創世記翻譯作「起初」，而約翰福音翻譯作「太初」？差別在於約翰福音一1太初有道的「有（Ἐν，En）」，乃是「未完成第三人稱Be動詞」，可翻譯為「早已有，或早已存在」。所以「太初有道」是從「起初，道早已存在」意譯而來的。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                以賽亞書四十一4強調神的宣召：「誰行做成就這事，從起初宣召歷代呢？就是我耶和華！我是首先的，也與末後的同在。」以賽亞書四十六10強調神的預言：「我從起初指明末後的事，從古時言明未成的事，說：我的籌算必立定；凡我所喜悅的，我必成就。」全都表明，神有完整的計畫與絕對的權柄，從起初，到歷代，到末後，神都掌權，都必按著神的心意來成就，他既創造了世界，也必將世界帶向一個美好的終結。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（鄺炳釗，《創世記（卷一）》，頁65）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
