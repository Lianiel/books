        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                創造的希伯來原文是 בָּרָא（bara），創世記第一章裡面，「創造」這個字共出現五次，在三節經文裡面：創世記一1講創造天地，一21講造出大魚，一27講造人、造男造女。這些並不都是無中生有，譬如造人，有使用塵土為材料（創二7）。這個字的通用意思並非無中生有，乃是前無今有。造出新的物、新的事，都可以用 בָּרָא（bara）這個字。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                從上述例子可看到，בָּרָא（bara）的主詞一定是神，他是創造天地的那一位，也是創作新事的那一位，其內涵有時好像與「轉化」相似，不變的是當神 בָּרָא（bara），一定是新鮮的、突然的、出人意外、不可思議的，顯出神無可比擬的性質。
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                諸天除了可包含天使，可能也包含天堂樂園這個靈界的天，保羅提到他曾被提到第三層天，並稱之為樂園（林後十二2-4）。神在地上設立樂園之前，讓天上先有樂園，這符合神做事的法則。不管會幕、聖殿，都是先有天上的，而後才有地上的（來八5，九23-24，代上廿八11-19）。配合保羅的說法，第一層天可能是地球大氣層範圍的天，是第二日的時候造的（創一6-8）；第二層天可能是日、月、眾星所在之處，第四日的時候才完全安置好（創一14-19）。
              </p>
              <p className="text-gray-700 leading-relaxed">
                創一章好像是在講神對宇宙的創造，其實最主要是在講神對「地」的預備。從第二節開始，就集中講地、然後講人。地與人是明顯的主角，佔聖經最多篇幅；神與天是隱藏的主角，雖然佔比較少的篇幅，但卻是真正左右全局的關鍵。如同啟示錄最多且最明顯的畫面是地上的災難，但主旋律其實是天上的敬拜。一生之久，我們活在地上，要與地連結，但我們同時也要與天連結，活在神面前，才能有得勝的人生。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                很多人不了解創造的神蹟本質，懷疑神怎麼可能只用六天就把天地都創造好了。我們要用神學與科學雙重角度來說明這事。關於科學的角度，可以參考孫大程博士所寫的《創世以來的奧秘》、亨利．莫瑞士（Henry M. Morris）所寫的《科學創造論》等書，有更詳細的資料。
              </p>
              <div className="space-y-3">
                {[
                  ...
                  { title: '創造留下證據：五餅二魚留下十二籃', desc: '神的創造留下清楚的證據，正如耶穌所行的另一個創造性神蹟——五餅二魚給五千人吃飽，眾人吃飽後還剩下十二籃的零碎，這是創造後所留下的證據。哥林多後書五17說：「若有人在基督裡，他就是新造的人。」「新造」原文就是「新創造」，一個人經歷重生得救後，會知道神的創造是真的，因為神的創造就發生在他身上。也有人經歷創造性的醫治神蹟，也會留下證據。' },
                ].map((item, i) => (
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mt-3">
                近代科學之父牛頓是虔誠的基督徒，他研究科學是為了想要更認識神。早期的科學家幾乎都是如此，他們研究科學的動機與神學家研究神學的動機是相似的。讓我們藉著創世記的啟示，也更加認識這位創造的主，並委身於他。耶穌說：「愛父母過於愛我的，不配作我的門徒；愛兒女過於愛我的，不配作我的門徒；不背著他的十字架跟從我的，也不配作我的門徒。」（太十37-38）耶穌這話在強調，他就是造物主，我們理當愛他超過一切，專一地來跟隨他。
              </p>
            </div>
