        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                那時天上的水氣層與今日的雲層不同，現今雲層所含的水量還不到全世界水量的1%，大雨無法下很久，通常幾小時就結束了，頂多一整天，就足以造成嚴重的水災。若下四十晝夜的大雨，又有從地下冒出來的水，肯定把整個城市都淹掉了，甚至連所有高山都淹沒了：「18水勢浩大，在地上大大地往上長，方舟在水面上漂來漂去。19水勢在地上極其浩大，天下的高山都淹沒了。20水勢比山高過十五肘，山嶺都淹沒了。」（創七18-20）這裡所說的高山，絕不是喜馬拉雅山或玉山之類的山，那都是洪水後才有的山，是破裂的陸塊推擠出來的，而且現在還在推擠，每年還在長高。盤古大陸的高山都不很高，所以會全部被淹沒。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（孫大程，《創世以來的奧秘》，頁125-126）</span>
              </p>
              <p className="text-gray-700 leading-relaxed">
                大淵泉源「裂開」與天上窗戶「敞開」的原文，字幹都是被動的（Niphal），代表是出於其他外力而發生的，這外力就是神自己，是神掌管這個審判<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《始於神──創世記靈修日引》，2月17日）</span>。有科學家提出隕石造成水氣層破裂的說法，這是一種可能，如同神使用大東風分開紅海。但大東風準確地發生在摩西伸杖吩咐之後，水氣層破裂準確地發生在挪亞全家進方舟後七天，這都是由於神超自然的掌管。今天不管發生甚麼難以掌控的事，要相信是出於神。即使有撒旦的工作，也是神所允許的，就如約伯的苦難、耶穌的十架、使徒的殉道等，為要磨練我們成為精金（伯廿三10，彼前一7）。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                這也是人類學的研究，全世界有兩百多民族有大洪水的傳說，地理位置遍佈各大洲，並涉及八十四個語言系統。不只中東民族，似乎全世界各民族都紀錄了這毀滅性的大洪水事件。有來自兩百多個民族的兩百多個傳說，其內容雷同的比例如下<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（摘自《校園》1995年5月號，頁24-25；莊東傑，《跨越鴻溝》，頁298-300）</span>：
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                還有一件事是很多人關心的，到底恐龍有沒有被帶進方舟？既然說，凡有血肉的活物，都要帶進方舟（創六19），那應該是有。由於容量的限制，一定是帶各種幼年的恐龍進方舟，但在洪水後的世界，由於氧壓、氣壓都比洪水前低，不適合大型體積的恐龍生存，因氧氣供應不到肢體末端。即使體積小一點的恐龍，也可能由於生存環境的變化，造成不易生育等，逐漸絕跡。《創世以來的奧秘》這本書指出，約伯記有記載像恐龍的動物，只是沒有稱之為恐龍，約伯記是與創世記同樣古老的一卷書，但愈到近代，因大環境不適合恐龍生存、數量不斷減少，又有人類追殺，這物種就絕跡了。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（孫大程，《創世以來的奧秘》，頁19-24）</span>
              </p>
            </div>
