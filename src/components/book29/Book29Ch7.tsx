  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-1"><sup>14</sup>神說：天上要有光體，可以分晝夜，作記號，定節令、日子、年歲，<sup>15</sup>並要發光在天空，普照在地上。事就這樣成了。<sup>16</sup>於是神造了兩個大光，大的管晝，小的管夜，又造眾星，<sup>17</sup>就把這些光擺列在天空，普照在地上，<sup>18</sup>管理晝夜，分別明暗。神看著是好的。<sup>19</sup>有晚上，有早晨，是第四日　創世記一14-19</p>
      </div>
        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                按目前天文學的觀測成果，地球及太陽系所在的銀河系，共有約一千億個恆星。整個宇宙原估計有二千億個類似銀河系的星系，最新估計再增加10倍，可能有二兆個星系。<sup>1</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（馬克·貝特森，《神啊！讓我聽見祢：與神連線的七種密語》，頁40）</span>這些都是神在第四日所造的。為何神要造這麼多星球，造這麼大的宇宙？筆者的答案有兩個：一是讓我們知道神的偉大，如啟示錄四11所說：「我們的主，我們的神，你是配得榮耀、尊貴、權柄的；因為你創造了萬物，並且萬物是因你的旨意被創造而有的。」二是讓我們有一個可近乎無限成長的空間，如啟示錄廿二5所說：「……他們要作王，直到永永遠遠。」
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                孫大程博士所寫的《創世以來的奧秘》，以科學的角度指出大爆炸理論的錯誤；也提供了許多資料，幫助我們相信宇宙是年輕的，在大約一萬年前，神造了地球、太陽、月亮、眾星，並賦予它們成熟的樣貌，被造次序是照聖經所記載的，這樣的觀點是筆者所認同的。<sup>2</sup><span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（孫大程，《創世以來的奧秘》，頁41-63）</span>為避免佔用太多篇幅，鼓勵有興趣的人去讀孫博士的書。本書則以「以經解經」及「屬靈生命」為優先。
              </p>
              <p className="text-gray-700 leading-relaxed">
