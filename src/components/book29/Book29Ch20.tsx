        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              上一章已經說明，引誘始祖犯罪的蛇不是一般的蛇，很可能是撒旦自己，或者是撒旦藉蛇說話。所以蛇說話，就是撒旦說話。撒旦的希伯來文是 שָׂטָן（sadan），在舊約出現23次，其中14次是用來作魔鬼的名字，其他9次有不同的翻譯，包括敵擋（2次）、敵人（4次）、仇敵（1次）、反對（1次）、對頭（1次）。所以撒旦這個字，本來就是敵人、對抗者的意思，稱為撒旦，因為牠是神的對敵，專門來敵擋神。牠所做的事，不一定都是很壞的事，但只要能讓人偏離神，讓人不專心愛神、不緊緊跟從神，那就是牠要做的事。
            </p>
            <p className="text-gray-700 leading-relaxed">
...
一次禱告沒蒙應允 →「神根本不聽我的禱告。」
某位弟兄姊妹傷害我 →「教會的人都很假。」
牧者一句話讓我受傷 →「所有牧者都只會控制人。」
我又跌倒犯罪一次 →「我永遠不可能改變，神一定也厭煩我了。」
服事沒有被肯定 →「我做什麼都沒有價值，沒有人在乎。」
讀經時沒有感動 →「我跟神的關係一定很差。」
家庭祭壇一次失敗 →「我們家根本不可能建立屬靈生活。」
看到世界很多黑暗 →「神根本沒有掌權。」
