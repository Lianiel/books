          ...
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <p className="text-gray-700 leading-relaxed mb-2">
                  麥基洗德這名字本身有清楚的意思，「麥基」直譯是我的王，「洗德」直譯是公義的。整個名字的意思就是「公義的王」。他又是撒冷王，是平安王的意思。這位麥基洗德，預表耶穌基督，因為他無父，無母，無族譜，無生之始，無命之終，乃是與神的兒子相似（來七3），又說利未人都是必死的，而麥基洗德是活的（來七8）。同時，希伯來書六次說耶穌基督是按著麥基洗德的等次作祭司（來五6，10，六20，七11，15，17）。
                </p>
                <p className="text-gray-700 leading-relaxed">
