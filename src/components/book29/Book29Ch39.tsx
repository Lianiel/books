        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                小兒子希伯來文是קָטָן（qatan，小、年幼）與בֵּן（ben，兒子）的複合詞，「小兒子」原文有孫子、子孫之意，意思是年幼的兒孫。對以色列人而言，後裔、子孫、兒子、兒孫，都是同一個概念。馬太福音一1：「亞伯拉罕的後裔、大衛的子孫，耶穌基督的家譜」，也可以翻譯作：「亞伯拉罕的兒子、大衛的兒子，耶穌基督的家譜」，因為兒子、後裔都是同一個字。在聖經中只要看到兒子，其實都包括了孫子、子孫，因此這節聖經中所說的「小兒子」應該就是最小的兒孫迦南。留意聖經的筆法，含有四個兒子，但這段經文只提到迦南，那是因為迦南做了該受咒詛的事，而非列出來要作為代罪羔羊。聖經特意把迦南與三個已過百歲的大人並列，就是要讓大家知道迦南是那位犯了罪的小兒子——最小的兒孫。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
