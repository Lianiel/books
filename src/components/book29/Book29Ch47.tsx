            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <p className="text-gray-700 leading-relaxed mt-2 mb-2">
                  創世記十七1-2：「1亞伯蘭年九十九歲的時候，耶和華向他顯現，對他說：我是全能的神。你當在我面前作完全人，2我就與你立約，……」這裡清楚說，你當作完全人，我就與你立約，所以立約的條件是「在神面前作完全人」，此句原文直譯是「你當在我面前走，作完全人」。「走」הִתְהַלֵּךְ（hithhallek）這個字的字幹表示持續不斷的行動，可指親密地與神同行，以諾、挪亞與神同行，也都使用這個字。
                </p>
              ...
              <div className="mb-3">
                ...
                <p className="text-gray-700 leading-relaxed mb-2">
                  這裡最特別的是將亞伯蘭的名字改為亞伯拉罕，並對亞伯拉罕說，你要作多國的父（創十七4-5）。「亞伯」是父親、阿爸之意，「蘭」是高舉之意，「拉罕」是多國之意。「高舉」偏向世俗意義，追求崇高地位，大概是他拉尚未信主之前對兒子的期望。「多國」主要是屬靈意義，代表將要祝福多國。
                </p>
                <p className="text-gray-700 leading-relaxed mb-2">
