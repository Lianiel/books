        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                「敗壞」這個字可指物的腐壞、建物的瓦解、道德的敗壞等。同一個字另一個文法型式，意思是「促使毀壞」，可翻譯作「毀滅」，本段經文最後一小句「把他們和地一併毀滅」，正是用這個字。這字在舊約出現147次，大多就是這兩種意義：「敗壞」與「毀滅」。可以這樣說，因為人與地已經自己先毀壞了，所以神就促使它毀壞，也就是毀滅它。神所做的審判工作，其實都是照著這個原則──人先自毀，神再毀之。<span style={{ fontSize: 'calc(1em - 6px)', color: '#9ca3af' }}>（謝挺，《始於神──創世記靈修日引》，2月14日）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
