          ...
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700 leading-relaxed mt-2 mb-3">
                  筆者手上有一份資料名為《失落在東方的羊兒》<sup>13</sup><span style={cite}>（Esther Chen，《失落在東方的羊兒》，中華牧羊系列叢書第一卷）</span>，特別研究羌人的信仰生活，羅列羌人與以色列人眾多相似之處，包括獻羊與無酵餅為祭給天神，祭司服飾，祭壇、房屋的材料樣式，大衛之星的圖案，完整的獻祭程序，成人禮、婚禮的執行，在門框上塗羊血或掛紅布等。
                </p>
                <p className="text-gray-700 leading-relaxed">
