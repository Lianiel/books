    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="border border-amber-100 rounded-lg overflow-hidden shadow-sm">
        <div className="p-5 bg-white space-y-4">
          ...
          <p className="text-gray-700 leading-relaxed">
            筆者所研究的內容，不僅說明華人祖先相信一位上帝，知道這位上帝是公義、慈愛的，並且進一步說明，華人祖先與這位上帝的關係有因信稱義的精神。這在甲骨文、金文、五經、論語、孟子等資料中，都有鮮明的呈現。
          </p>
          <p className="text-gray-700 leading-relaxed">
          ...
          <p className="text-gray-700 leading-relaxed">
            筆者曾在《恩福》雜誌總47-50四期連載〈華人回家：創世記與華人先祖〉一文，本書前四章的內容與這四期所刊的內容相似。本書第六章第二節則大致採用筆者所寫〈羌人與羊文化〉一文，曾刊載於《恩福》雜誌總57期，皆經《恩福》雜誌同意採用。為何先投稿於《恩福》雜誌，除了能先與《恩福》雜誌讀者分享外，主要目的之一也是為累積本書內容。今能成書，除了感謝上帝，也要感謝《恩福》雜誌。
          </p>
