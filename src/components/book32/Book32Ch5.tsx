        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                船：會意字，「八口」在「舟」裡面，得以躲避洪水，此為特殊之「船」，非一般之「舟」（創六10、18）。<sup>2</sup><span style={cite}>（朱天民，《中國字》，頁231-233。葉天樹，《中華民族文字學與三位一體真神的關係》，頁145-148）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                舫：會意字，「方」形的「舟」，用以承裝人、動物、食物，以避洪水，非為航行（創六14-21）。<sup>3</sup><span style={cite}>（葉天樹，《中華民族文字學與三位一體真神的關係》，頁149-150）</span>
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
