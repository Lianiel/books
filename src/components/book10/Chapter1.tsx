    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        <div className="space-y-6">
          ...
          <StoryCard
            title="✨ 神蹟般的翻轉"
            content="接下來發生的事讓所有人驚呆了：教會被迫買下原本3倍的水權分攤費（12萬美元）但南加州遇到旱災，水權價格飆漲地主請求買回2/3的水權，價格：25萬美元！教會不但沒虧，還從這筆交易中賺了13萬美元最終買到的土地從80英畝變成130英畝，價格更便宜上帝的智慧遠超過人的計算！"
            highlight={true}
          />
      ...
      >
        <div className="space-y-6">
          ...
          <StoryCard
            title="😰 前兩晚的慘敗"
            content="李拉瑞充滿信心地傳講福音。他知道自己有傳福音的恩賜，講章也準備得很好。第一晚：沒有一個人回應呼召。第二晚：還是沒有人。李拉瑞開始擔心：『到底怎麼回事？我的講章蠻不錯的，神學觀點純正，福音信息清楚，但為什麼會這樣？回達拉斯後要如何向我的青年團契交代？』"
            highlight={true}
          />

          <StoryCard
            title="🙏 兩位婦女的代禱"
            content="第三晚，聚會在衛理公會舉行。李拉瑞提前到達，兩位婦女走向他。她們看見他一副緊張的樣子，就說：『不要擔心，弟兄，今天我們已為你禱告了八個小時。』她們詢問是否可在那兒為他按手禱告。當禱告結束時，其中一位問：『「成了」這句話對你有什麼意義嗎？』那正是李拉瑞當晚要用的經文！"
            highlight={true}
          />

          <StoryCard
            title="🔥 突破性的果效"
            content="那天晚上，李拉瑞上台傳講，結果：一百個人回應呼召！隔天晚上，他又去尋找那兩位女士。她們再次為他禱告，另一位問他是否記得患血漏症的婦女——那又是他當晚選用的經文！整週結束前，有五百人決志相信基督。"
          />
