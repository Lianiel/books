...
import { TrendingUp, TrendingDown, Zap, Target, Compass, Heart, Sparkles, Shield, BookOpen, ChevronDown, ChevronUp, Brain, MessageCircle, Scale, Flame, Gift, Crown, Church, CalendarCheck, BookMarked, MessageSquareQuote, DollarSign, Clock, BookOpenCheck, AlertTriangle, Plane } from 'lucide-react';
