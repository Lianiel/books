    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      {/* Reflection & Action Guide */}
        ...
        <div className="bg-gradient-to-br from-teal-50 to-slate-50 border border-teal-100 rounded-2xl p-6 mb-6">
          ...
          <div className="mb-4">
            <div className="text-xs font-bold text-teal-600 mb-1.5">📖 婚姻中的界線問題</div>
          ...
          <div className="mb-4">
            <div className="text-xs font-bold text-teal-600 mb-1.5">🔍 「種豆得豆」在婚姻中的應用</div>
          ...
          <div className="mb-4">
            <div className="text-xs font-bold text-teal-600 mb-1.5">⚠️ 愛需要兩個有界線的個體</div>
