        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4 ml-2">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">「起初　神創造天地」的「神」字，希伯來文原文（אֱלֹהִים，以羅欣，Elohim）本是複數，本應譯為「神們」。但是，按文法，複數名詞本應接著複數動詞；這裏，在「神們」後面卻緊接著單數動詞——「創造」（בָּרָא，巴拉，bara）。這充分指明「神們」本是同一體，即是聖父、聖子、聖靈三位一體：聖父總理與計劃，聖子助理與救贖，聖靈執行與作工，原本為一，都包括在這「神」——宇宙至高者之內了。另外，請注意，這動詞的用法，是專指主語是男性的，所以，三位一體的神是男的；也就是說聖父、聖子、聖靈是男性的。</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">文中「神的靈運行在水面上」，「運行」原文（מְרַחֶפֶת，麥拉赫費特，merachefet），含有孵化與翱翔的意思。聖靈此時專注在使地球運化成形，正在執行父神的創造計劃。</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                文中，神「造了兩個大光」的「造」字，希伯來文原文（עָשָׂה，阿薩，asah），與第一日那「創造」原文（בָּרָא，巴拉，bara）不是同一字。這個「造」字，若譯為「製造」更為恰當，是用已存在的物質，將之改變合乎使用之意。這個觀念可用公式表明如下：E（能量）= M（質量）× C²（光速平方）。這裏，在第一日，神運化黑暗星雲，將能量放光產生星球物體後，神又在第四日，將有的星體賦與能量，使其聚集成氫氣原子爐，開始作用成太陽。至於那小光，反射陽光，管理地球黑夜的月球，顯然是直等到第四日，才開始在地球軌道上服役，源自何處並不重要。太陽系直到第四日，才具現今規模。地球開始有了自己的晝夜系統，大地的植物，在第四日之前的光合作用下，大量製造了氧氣，　神已經為地球生物預備好了生長環境。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                聖經中，「　神就造出大魚」的「造」字，希伯來文原文（בָּרָא，巴拉，bara），是與第一日的「創造」同字，顯然是將地球的某種元素，變化成一種完全不同的生命出來。同時，我們由這段經文中可以看出，神創造是有次序的，祂先在水中創造出各種生物，接著，又造了各樣會飛的生物，尚未造出陸地上的動物，這是與進化論最大的不同點。其次，神創造植物與動物，都是「各從其類」的，顯然，從起初，不同類的物種（Species），就無法配種產生新品種，這種生物定律，到今天還是金科玉律沒有改變。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                首先，神「造野獸、牲畜、昆蟲」的「造」字（עָשָׂה，阿薩，asah），以及創世記一章26節神計劃及說要「造人」的「造」字，是與　神在第二日及第四日的「造」字相同，都是用已存在的物質改變「製造」之意。但是創世記一章27節　神實際照著祂的形像「造人」的「造」字，卻是（בָּרָא，巴拉，bara），在這一節裏，一共引用兩次，都是與　神在第一日及第五日所用的「造」字相同，是「創造」的意思，即是變化成完全不同的生命出來。這裏充分證明人表面看起來好像和其他動物類似，實際上人和其他動物大不相同。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                人為何有這種超乎諸受造物的能力呢？原來，這奧祕早在創世之初就顯現出來了。那時，三位一體的真神在決定造人的計劃，人是照著祂的「形像」和「樣式」造的，這就是人和其他動物最大不同之處。這就是何以　神實際「造人」的時候，是用希伯來文（בָּרָא，巴拉，bara）這個字，足見其「創造」過程是有別於一般的動物的。這裏也就能解釋為什麼猩猩、猴子，也同樣擁有　神的「形像」及「樣式」，也只有人能像　神。我們知道，兒子的特徵，就在像那生他的，同理，人起初被造時，在外貌與心性方面就應像那造他的　神，所以亞當在聖經中被稱為　神的兒子（路加福音三章38節）。
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                神在創造地球萬物及人類後，就歇了祂一切創造的工，並聖化此日，安息了。這「安息」的希伯來文（שָׁבַת，沙巴特，shabbat），並非是一種勞累需要休息睡眠的意思，而是有一種停止創造工作，卻仍在管理和維繫一切受造物的含意。安息只是不再創造新生命，就像今天在世上的生物，自從　神創造天地以來，就沒有改變一樣；所以雖是安息，　神並沒有不作事，就像耶穌說的「我父作事直到如今，我也作事」（約翰福音五章17節）意思一樣。
              </p>
              <p className="text-gray-700 leading-relaxed">
        ...
        {expanded['summary'] && (
          <div className="p-5 bg-white">
            <ul className="space-y-2">
              {[
                '希伯來文「神」（אֱלֹהִים，以羅欣，Elohim）是複數名詞卻配單數動詞「創造」（בָּרָא，巴拉，bara），充分說明神是三位一體：聖父計劃、聖子救贖、聖靈執行，同為一體的創造主。',
        ...
        {expanded['exploration'] && (
          <div className="p-5 bg-white space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">神第七日安息並非因疲倦，「安息」（שָׁבַת，沙巴特，shabbat）含義是「停止創造、繼續維繫」。安息日誡命（出埃及記二十章8-11節）指向三個層面：紀念神的創造之工；預示進入神國的屬靈安息（希伯來書四章9-11節）；以及耶穌基督本人就是我們的安息——「凡勞苦擔重擔的人可以到我這裏來，我就使你們得安息」（馬太福音十一章28節）。</p>
            </div>
          </div>
        )}
      </div>
