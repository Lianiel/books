    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-4 border border-purple-100 rounded-lg overflow-hidden shadow-sm">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-800 text-left text-sm">羅馬書七章的苦中人是誰？</span>
          </div>
      ...
      <div className="mb-4 border border-purple-100 rounded-lg overflow-hidden shadow-sm">
        ...
        >
          <div className="flex items-center gap-2">
            <BookOpen className="w-4 h-4 text-purple-600 flex-shrink-0" />
            <span className="font-semibold text-gray-800 text-left text-sm">保羅是否在描述基督徒經驗？</span>
          </div>
      ...
      <div className="mb-4 border border-purple-100 rounded-lg overflow-hidden shadow-sm">
        ...
        >
          <div className="flex items-center gap-2">
            <BookOpen className="w-4 h-4 text-purple-600 flex-shrink-0" />
            <span className="font-semibold text-gray-800 text-left text-sm">四點論證分析</span>
          </div>
      ...
      <div className="mb-4 border border-purple-100 rounded-lg overflow-hidden shadow-sm">
        ...
        >
          <div className="flex items-center gap-2">
            <BookOpen className="w-4 h-4 text-purple-600 flex-shrink-0" />
            <span className="font-semibold text-gray-800 text-left text-sm">結論：信主後的基督徒保羅</span>
          </div>
        ...
        {expanded['sec3'] && (
          <div className="p-5 bg-white">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">（保羅從福音得來的另一方面的自我認識，記在第八章裡。）全段的論題「我是屬乎肉體的，是已經賣給罪了」，是類別性地提說出來，並沒有清楚地界定含意，原因不是這裡已包含了有關信徒保羅的全部真相，而是因為這是律法唯一能夠告訴他關乎自己的部分真相。律法帶給基督徒的就是讓他認識到那仍舊在他裡面的罪。當他借助律法的亮光去檢視自己的生命時，他經常發現他心裡願望行善，但行出來總是有所不及的；因此，他「覺得」罪惡仍舊在他裡面，他在某個程度上來說仍舊被罪惡俘擄（21 —23 節）。於是，他在不斷犯罪的境況中，及認識到只要一日會朽壞的軀體尚存，他就難以脫離居衷的罪——那內裡麻煩的住客；這就是他的苦況了。他很痛苦地意識到在目前，他想達致的遠超乎他所能掌握的；所以，他渴求末後的拯救，那時候，意願與成就、目標與表現、計畫與行動的矛盾緊張就會全然消弭。這個解釋似乎很能夠配合上下文和整段經文的細節，尤其使第二十四至二十五節的意思清楚明確，這是許多較為普遍的解釋所缺乏的。</p>
              <p className="text-gray-700 leading-relaxed mb-3">（ExiStence and Faith  shorter Writ ings of Rudolf Bultmann，trans．Schubert M． Ogden，［London： Hodder ＆ Stoughton， 1961］，第147頁）。</p>
              <p className="text-gray-700 leading-relaxed mb-3">在 The EXpositor’s Greek Testament 。</p>
              <p className="text-gray-700 leading-relaxed mb-3">C． L． Mition，“Romans Ⅶ Reconsidered：Ⅲ，” Expository  Times 65（1954）： 133．</p>
          </div>
        )}
      </div>
    </div>
