...
const characters: Character[] = [
  ...
  { id: 'enoch-cain', name: '以諾（該隱的子孫）', englishName: 'Enoch (Son of Cain)', subtitle: '該隱為之建城的兒子', era: '摩西五經', books: '創世記', quote: '世界上第一座城市的名字就是我的名字！', description: '該隱的兒子，以東方建立的第一座城市命名為「以諾城」，是人類最早城市文明的起點。', },
  { id: 'enosh-etc', name: '以挪士、瑪土撒拉、拉麥（塞特後代）', englishName: 'Enosh, Methuselah, Lamech', subtitle: '塞特後代，挪亞的祖先', era: '摩西五經', books: '創世記', quote: '我們是以方舟聞名的挪亞之祖先', description: '塞特的後裔，形成信仰族系的主幹，最終出了以諾和挪亞。瑪土撒拉是聖經中壽命最長的人，活了九百六十九歲。', },
  ...
  { id: 'gomer-japheth', name: '歌篾等（雅弗之子）', englishName: 'Gomer (Sons of Japheth)', subtitle: '雅弗的後代', era: '摩西五經', books: '創世記', quote: '我們雅弗一族遍佈泛海地區廣展網絡', description: '雅弗的後代包括歌篾、瑪各、瑪代、雅完等族，廣佈於希臘、小亞細亞及歐亞各地，成為各沿海地區民族的祖先。', },
  { id: 'elam-shem', name: '埃蘭等（閃之子）', englishName: 'Elam (Sons of Shem)', subtitle: '閃的後代', era: '摩西五經', books: '創世記', quote: '中東高原地帶是我們閃族的勢力範圍', description: '閃的後代包括埃蘭、亞述、亞法撒、路德、亞蘭等族，分佈於中東地區，是包括以色列人在內的「閃族語言」民族之祖先。', },
  ...
  { id: 'cush-put', name: '古實、弗', englishName: 'Cush, Put', subtitle: '含的兒子', era: '摩西五經', books: '創世記', quote: '我們含族在非洲定居繁衍子孫', description: '含的兒子，古實是衣索比亞人的祖先，弗是利比亞一帶民族的祖先，兩族都在非洲大陸發展繁衍。', },
  { id: 'canaan', name: '迦南', englishName: 'Canaan', subtitle: '含的兒子，迦南人的祖先', era: '摩西五經', books: '創世記', quote: '我雖然被挪亞詛咒，仍然繁衍出眾多的迦南民族', description: '含的小兒子，因父親偷看挪亞的醜態而受到詛咒，他的後代成為迦南地區各民族的祖先，後來以色列人征服了這塊土地。', },
  ...
  { id: 'shelah', name: '沙拉（亞伯拉罕祖先）', englishName: 'Shelah', subtitle: '亞伯拉罕的先祖', era: '摩西五經', books: '創世記', quote: '我是亞伯拉罕的祖先', description: '閃的後代，亞伯拉罕的先祖之一，構成從挪亞到亞伯拉罕的譜系鏈結。', },
  { id: 'eber-etc', name: '希伯、法勒、約坍、拉吳、西鹿', englishName: 'Eber, Peleg, Joktan, Reu, Serug', subtitle: '亞伯拉罕的先祖群', era: '摩西五經', books: '創世記', quote: '我們是以色列之祖亞伯拉罕的祖先', description: '這些人是從閃到他拉之間的族長，構成通往亞伯拉罕的直系譜系。希伯被認為是「希伯來人」名稱的由來。', },
  { id: 'terah', name: '他拉', englishName: 'Terah', subtitle: '亞伯拉罕的父親', era: '摩西五經', books: '創世記', quote: '我和亞伯拉罕等人一起遷居到哈蘭', description: '亞伯拉罕的父親，帶領家人從迦勒底的吾珥出發往迦南，中途抵達哈蘭後便定居於此，在哈蘭去世，享年二百零五歲。', },
  { id: 'nahor-haran', name: '拿鶴、哈蘭', englishName: 'Nahor, Haran', subtitle: '亞伯拉罕的兄弟', era: '摩西五經', books: '創世記', quote: '我們留在迦勒底的吾珥', description: '亞伯拉罕的兩個兄弟，拿鶴娶密迦為妻留在吾珥，哈蘭是羅得的父親，在出發前便早逝於吾珥。', },
  ...
  { id: 'keturah', name: '基土拉', englishName: 'Keturah', subtitle: '亞伯拉罕的妾（續絃）', era: '摩西五經', books: '創世記', quote: '我作為續弦生下六個小孩', description: '撒拉去世後嫁給亞伯拉罕的妾，生了六個兒子，後代成為阿拉伯半島各族的祖先。', },
