...
const chapters = [
  ...
  { path: '/book39/chapter7', title: '第七章　與基督連結——加爾文倫理學' },
  ...
  { path: '/book39/chapter12', title: '第十二章　尼布爾式理想主義——務實倫理學' },
  { path: '/book39/chapter13', title: '第十三章　自發性回應責任——責任倫理學' },
  { path: '/book39/chapter14', title: '第十四章　為主抉擇——潘霍華倫理學' },
  { path: '/book39/chapter15', title: '第十五章　文學家的視域——路易斯倫理學' },
  { path: '/book39/chapter16', title: '第十六章　現代基督教倫理學——從巴特到莫特曼' },
  { path: '/book39/chapter17', title: '第十七章　生命倫理' },
  { path: '/book39/chapter18', title: '第十八章　總結' },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 p-5 bg-slate-50 border border-slate-100 rounded-lg">
        ...
        <p className="text-gray-500 text-sm mt-3">全書共十八章，已全部完結：第一部「導論」（第一、二章）、第二部「聖經」（第三章舊約、第四章新約）、第三部「傳統」（第五至十章：奧古斯丁、路德、加爾文、重洗派、衛斯理、天主教）、第四部「類型」（第十一至十三章：德行、務實、責任倫理學）、第五部「現代」（第十四至十七章：潘霍華、路易斯、巴特到莫特曼、生命倫理），以及第十八章「總結」。</p>
      </div>
