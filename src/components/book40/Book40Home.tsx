...
const chapters = [
  ...
  { path: '/book40/chapter18', title: '第十八章　第九誡：不可作假見證陷害人' },
  { path: '/book40/chapter19', title: '第十九章　第十誡：不可貪心（全書結語）' },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 p-5 bg-amber-50 border border-amber-100 rounded-lg">
        ...
        <p className="text-gray-500 text-sm mt-3">全書前言、第一至十九章已全部完結上線，十誡逐條詳解齊備（第七誡「不可姦淫」因篇幅龐大細分六個子題探討）。</p>
      </div>
