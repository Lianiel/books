  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 p-5 bg-amber-50 border border-amber-100 rounded-lg">
        ...
        <p className="text-gray-500 text-sm mt-3">目前已上線：前言、第一章「基督教倫理學概論」、第二章「倫理三大觀點應用實例」、第三章「十誡緒論」、第四章「第一誡」、第五章「第二誡」、第六章「第三誡」、第七章「第四誡」、第八章「第五誡」、第九章「第六誡（上）」、第十章「第六誡（下）」。全書後續章節（第七誡至第十誡）將陸續增補。</p>
      </div>
