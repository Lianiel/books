      ...
      <div className="mb-6 border border-purple-100 rounded-lg overflow-hidden shadow-sm">
        ...
        {expanded['content'] && (
          <div className="p-5 bg-white space-y-5">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-gray-700 leading-relaxed space-y-2">
              <p className="font-semibold text-amber-800">補充說明：</p>
              <p>聖經中共有三次提到：「不可用山羊羔母的奶煮山羊羔。」</p>
              <ul className="space-y-1 ml-2">
                <li>「不可用山羊羔母的奶煮山羊羔。」（出埃及記 23:19）</li>
                <li>「不可用山羊羔母的奶煮山羊羔。」（出埃及記 34:26）</li>
                <li>「不可用山羊羔母的奶煮山羊羔。」（申命記 14:21）</li>
              </ul>
              <p>原本經文的意思，可能與當時迦南異教的祭祀習俗有關，也可能是在表達對生命與母性的尊重，不要用原本養育生命的奶，反過來烹煮那生命。</p>
              <p>後來猶太拉比逐漸將這條律法延伸解釋為：「肉類與奶類不可混合食用。」因此發展成猶太潔食（Kosher）中的重要規定，不只是羊肉與羊奶，而是所有哺乳動物的肉類與奶製品都要分開，例如牛肉與牛奶、起司等也不可同時食用。</p>
              <p>因此，以色列航空在供應牛肉餐時，不會再提供牛奶，並不是因為食物相剋，而是為了遵守猶太教的潔食傳統與律法規範。</p>
            </div>
