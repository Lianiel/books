...
export default function Chapter2() {
  const [expandedSections, setExpandedSections] = useState<string[]>(['intro','challenge','christ-in-you','dead-to-self','direct-access','dont-react','fill-up','final-prayer','goliath','hebron','intimacy','milk-solid','vine']);
