...
export default function Chapter4() {
  const [expandedSections, setExpandedSections] = useState<string[]>(['discernment','five-senses','restoration','salvation-prayer','senses-training','sin-breaks-intimacy','small-things']);
