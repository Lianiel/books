      ...
      {/* Reflection & Action Guide */}
        ...
        <div className="bg-gradient-to-br from-teal-50 to-slate-50 border border-teal-100 rounded-2xl p-6 mb-6">
          ...
          <div className="bg-blue-50 border-blue-200 border rounded-xl p-4 mb-3">
            <div className="font-bold text-blue-700 mb-1.5" style={{fontSize:"18px"}}>📖 神有界線：最深的神學根基 <span style={{fontSize:"11px", fontWeight:"normal", opacity:0.7, marginLeft:"6px"}}>(P.350-356)</span></div>
            <p className="text-slate-600 leading-relaxed" style={{fontSize:"18px"}}>作者提出一個深刻的洞見：界線不只是心理健康的工具，它有深刻的神學基礎。神自己就有界線——祂給了我們自由意志，讓我們能夠真正選擇愛祂或拒絕祂；祂有祂不能接受的（罪）；祂寧願我們對祂誠實，也不要我們帶著假面具與祂同行。若神有界線，界線本身就不可能是罪。</p>
          </div>
          <div className="bg-violet-50 border-violet-200 border rounded-xl p-4 mb-3">
            <div className="font-bold text-violet-700 mb-1.5" style={{fontSize:"18px"}}>🔍 說「不」的具體策略 <span style={{fontSize:"11px", fontWeight:"normal", opacity:0.7, marginLeft:"6px"}}>(P.356-363)</span></div>
            <p className="text-slate-600 leading-relaxed" style={{fontSize:"18px"}}>作者提供幾個實用的說「不」策略：清楚而直接，不要過度解釋（解釋越多，對方越有反駁的空間）；使用「我」的陳述（「我現在沒有能力答應這個」，而不是「你要求太多了」）；練習「緩衝語言」（「讓我想想，我再告訴你」）；在低風險情境中練習，逐漸建立說「不」的肌肉記憶。</p>
          </div>
          <div className="bg-amber-50 border-amber-200 border rounded-xl p-4 mb-3">
            <div className="font-bold text-amber-700 mb-1.5" style={{fontSize:"18px"}}>⚠️ 罪惡感是成長的信號 <span style={{fontSize:"11px", fontWeight:"normal", opacity:0.7, marginLeft:"6px"}}>(P.363-370)</span></div>
            <p className="text-slate-600 leading-relaxed" style={{fontSize:"18px"}}>作者特別提醒：在學習說「不」的初期，罪惡感是幾乎必然的伴隨物。但這個罪惡感不代表你做錯了——它只代表你在打破一個舊有的模式。就像長期不運動的人初次運動會肌肉酸痛，初期的罪惡感是界線肌肉在成長的信號，不是你越界的警告。</p>
          </div>
          <div className="bg-emerald-50 border-emerald-200 border rounded-xl p-4 mb-3">
            <div className="font-bold text-emerald-700 mb-1.5" style={{fontSize:"18px"}}>💡 本章的關鍵信息 <span style={{fontSize:"11px", fontWeight:"normal", opacity:0.7, marginLeft:"6px"}}>(P.350-370)</span></div>
            <p className="text-slate-600 leading-relaxed" style={{fontSize:"18px"}}>說「不」是可以練習的技能，也是你能給他人最誠實的禮物之一。一個總是說「好」卻內心充滿「不」的人，最終給予的是虛假的愛。真正說「好」的能力，建立在說「不」的自由之上——當你有能力說不，你的「好」才有意義。</p>
          </div>
        </div>
